# This code uses the baseballr package to pull data for each mlb game from 2010 to 2019
# and then uses data from each game to pull more information about each game regarding attendance, weather, etc.
